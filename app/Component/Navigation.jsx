    ...
    <>
      <div className=" w-full  fixed top-4 z-50">
        <motion.nav
          ...
          className="flex dark:bg-black text-base rounded-2xl  bg-blue-600  dark:border-white/10 justify-between items-center p-6 md:p-10 h-14 backdrop-blur-sm  text-white font-sans max-w-7xl mx-auto"
        >
          {/* Logo */}
          <motion.div
